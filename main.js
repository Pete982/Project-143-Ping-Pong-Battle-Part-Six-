...
game_status = "start"; //Make the value of the game status to the Game is Loaded! 
document.getElementById("stauts").innerHTML = "the Game is Loaded!!!!"
}
...
function preload(){
  ...
  ball_touchh_paddel = loadSound("ball_touch_paddel.wav");

  missed_noise_paddel = loadSound("missed.wav");
